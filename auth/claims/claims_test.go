...
func TestVerify(t *testing.T) {
	...
	table := []struct {
	...
	}{
		{
			...
			err: ClaimInvalidError{Reason: NotBefore},
		},
		{
			...
			err: ClaimInvalidError{Reason: Expired},
		},
		{
			...
			err: ClaimInvalidError{Reason: IssuerMismatch},
		},
		{
			...
			err: ClaimInvalidError{Reason: IssuedAtFuture},
		},
		{
			...
			err: ClaimInvalidError{Reason: AudienceNotFound},
		},
		{
